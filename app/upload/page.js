...
import PreviewPage from "@/components/CheckoutTicket";
      ...
      <div className="flex m-auto flex-col items-center gap-4 max-w-md">
        ...
        >
          <CardHeader className="flex flex-col items-center gap-2">
            <CardTitle className="font-normal">Traffic Ticket Legal Service</CardTitle>
            <CardTitle className="text-4xl">$150</CardTitle>
              <CardDescription className="text-center">
               We can't guarantee 100% dismissal, but our lawyers will give it their all for your best shot.
              </CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col gap-4">
